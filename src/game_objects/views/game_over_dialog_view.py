...
class GameOverDialogView(Drawable):
    def __init__(self, game_over_dialog):
        ...
        self._main_text_surface = FONT_PRIMARY_XXLARGE.render('你被重启了！', False, Color.WHITE)
        self._uptime_text_surface = FONT_PRIMARY_LARGE.render('存活时间： ' + game_over_dialog.uptime, False, Color.WHITE)
